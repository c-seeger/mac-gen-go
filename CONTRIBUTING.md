...
## [Code of Conduct](https://github.com/virtomize/mag-gen-go/blob/master/CODE_OF_CONDUCT.md)

The mag-gen-go project follows the [Contributor Covenant Code of Conduct](https://github.com/virtomize/mag-gen-go/blob/master/CODE_OF_CONDUCT.md)
...
- By opening an issue for discussion: For example, if you found a bug, creating a bug report using the [template](https://github.com/virtomize/mag-gen-go/blob/master/.github/ISSUE_TEMPLATE/bug_report.md) is the way to report it.
- By providing supporting details to an existing issue: For example, additional testcases.
- By helping to resolve an issue: For example by opening a [Pull Request](https://github.com/virtomize/mag-gen-go/pulls)

### Asking for Help

Just open a [regular issue](https://github.com/virtomize/mag-gen-go/issues/new) and describe your problem.
...
Fork the project [on Github](https://github.com/virtomize/mag-gen-go/) and clone your fork

```
$ git clone git@github.com:username/mag-gen-go.git
$ cd mag-gen-go
$ git remote add upstream https://github.com/virtomize/mag-gen-go.git
$ git feth upstream
```
...
If your commits are ready to go and passed all tests and linting, you can start creating a [Pull Requests](https://github.com/virtomize/mag-gen-go/pulls) by pushing your work branch to your fork on GitHub.
...
Contributors guide: https://github.com/virtomize/mag-gen-go/blob/master/CONTRIBUTING.md
-->
...
Also follow the [Code of Conduct](https://github.com/virtomize/mag-gen-go/blob/master/CODE_OF_CONDUCT.md)
